...
#'
#' The \code{select_LE_Estimate_ori} function find the individual variants and gene-centric variants that are in linakge equilibrium
...
# Function
select_LE_Estimate_ori <- function(chr, df_indv, df_gene, genofile, obj_nullmodel, rare_maf_cutoff=0.01, rv_num_cutoff=2,
